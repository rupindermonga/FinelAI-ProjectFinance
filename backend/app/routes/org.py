...
ROLE_LABELS = {
    ...
    "finance_admin":   "Finance Admin — Finance read+write only (no PM access)",
    "finance_viewer":  "Finance Viewer — Finance read-only (no PM access)",
    "pm_admin":        "PM Admin — PM read+write only (no Finance access)",
    "pm_viewer":       "PM Viewer — PM read-only (no Finance access)",
